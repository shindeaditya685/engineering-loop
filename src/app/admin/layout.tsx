...
import {
  LayoutDashboard, Database, Mail, CalendarDays, LogOut,
  Menu, X, ChevronRight, ArrowLeft, Lightbulb,
} from 'lucide-react';
    ...
    <div className="min-h-screen bg-dark-900 flex">
        ...
        <div className="flex flex-col h-full">
          <div className="p-5 border-b border-white/[0.04]">
            <Link href="/admin" className="flex items-center gap-2.5">
              ...
              <div>
                <p className="font-display font-bold text-sm text-white">Engineering Loop</p>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="h-14 bg-dark-800/50 backdrop-blur-xl border-b border-white/[0.04] flex items-center px-4 gap-3 sticky top-0 z-30">
          <button onClick={() => setSidebarOpen(true)} className="lg:hidden p-2 rounded-lg text-gray-400 hover:text-white hover:bg-white/[0.04]">
